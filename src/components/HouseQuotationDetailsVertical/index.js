...
const HouseQuotationDetailsVertical = (props) => {
        ...
        <>
            <div className="pt-4">
                <div className="flex items-center pb-2">
                    ...
                    <p className={`${fire ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-2`}>Monto total contrato</p>
                </div>
                <div className="flex items-center pb-2">
                    <img src={partialDamage ? (props.item === props.selected ? partialdamagetruehigh : partialdamagetrue) : partialdamagefalse} alt="" />
                    <p className={`${partialDamage ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-2`}>Ocupación indebida</p>
                </div>
                <div className="flex items-center pb-2">
                    <img src={hail ? (props.item === props.selected ? hailtruehigh : hailtrue) : hailfalse} alt="" />
                    <p className={`${hail ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-4`}>Gastos de desalojo</p>
                </div>
                <div className="flex items-center pb-2">
                    <img src={totalDamage ? (props.item === props.selected ? totaldamagetruehigh : totaldamagetrue) : totaldamagefalse} alt="" />
                    <p className={`${totalDamage ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-2`}>Expensas ¡y más!</p>
                </div>
            </div>
            <div className="pt-4 pl-1">
                <div className="flex items-center pb-2">
                    <img src={tyre ? (props.item === props.selected ? tyretruehigh : tyretrue) : tyrefalse} alt="" />
                    <p className={`${tyre ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-2`}>Mínimo 1 inquilino</p>
                </div>
                <div className="flex items-center pb-2">
                    <img src={help ? (props.item === props.selected ? helptruehigh : helptrue) : helpfalse} alt="" />
                    <p className={`${help ? (props.item === props.selected ? `text-white font-OpenSansSemiBold` : `text-gray font-OpenSansSemiBold`) : `${props.item === props.selected ? `text-gray2` : `text-gray3`} font-OpenSansRegular`} text-sm pl-2`}>Ingreso totales $80.000</p>
                </div>
            </div>
        </>
    )
...
export default HouseQuotationDetailsVertical;
