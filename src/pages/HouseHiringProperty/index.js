...
const HouseHiringProperty = (props) => {
                                    ...
                                    <div className="">
                                        <div className="w-full block lg:flex">
                                            <div className="w-full lg:w-1/2 xl:w-3/5 mb-4 sm:mb-0">
                                                <CustomInput type="text" name="Provincia" content={firstName} error={validError.firstName.error} errorMsg={validError.firstName.msg} onChange={e => setFirstName(e.target.value)} />
                                                <div className="mt-8">
                                                    <CustomInput type="text" name="Domicilio" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                </div>
                                                ...
                                                <div className="mt-8 relative z-20">
                                                    <CustomInput type="number" name="Código Postal" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                </div>
                                            </div>
                                            <div className="w-full lg:w-1/2 xl:w-2/5 pt-8 lg:pt-0 pl-0 lg:pl-8 mb-4 sm:mb-0">
                                                <CustomInput type="number" name="Ciudad" content={dni} error={validError.dni.error} errorMsg={validError.dni.msg} onChange={e => setDNI(e.target.value)} />
                                                <div className="w-full relative mt-8 z-10">
                                                    <CustomInput type="number" name="Número" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                </div>
                                                <div className="w-full relative mt-8 z-10">
...
export default HouseHiringProperty;
