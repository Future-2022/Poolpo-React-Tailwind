...
const HouseCongrats = (props) => {
    ...
    const goHiringPictures = () => {
        let url = "/hiring/pictures/" + props.match.params.leadID + "/" + props.match.params.propertyID + "/" + props.match.params.quoteID;
        history.push(url);
    }
            ...
            <div className="w-full bg-pink8">
                <div className="w-full max-w-1296 mx-auto relative bg-pink8 pb-12" style={{ minHeight: "100vh" }}>
                    <HeaderHiring quotationitem={true} logoID={quote !== {} && !!quote.insurerObj ? quote.insurerObj.id : false}>
                        ...
                        <p className=" font-OpenSansRegular text-lg sm:text-xl text-gray text-left sm:text-center">
                            <span className="text-purple4 font-OpenSansBold">¡Ya sos parte de <span className="capitalize font-OpenSansSemiBold">{!!quote.insurerObj ? quote.insurerObj.name : ""}</span>! </span><br className="hidden sm:block" />
                    ...
                    <div className="w-full px-4 sm:px-12 xl:px-24 1xl:px-32">
                        <div className="bg-white px-2 sm:px-10 py-4 sm:py-8">
                            {!!quote.insurerObj &&
                                <img src={insurerLogo(quote.insurerObj.id)} alt="quotation" className="mx-auto h-12 block sm:hidden" />
                            }
                            <div className="flex items-center justify-between pb-5">
                                ...
                                {!!quote.insurerObj &&
                                    <img src={insurerLogo(quote.insurerObj.id)} alt="quotation" className="h-12 hidden sm:block" />
                                }
                            </div>
                                ...
                                <div className="flex items-center justify-between pt-2 pb-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="pl-4">
                                            ...
                                            <p className="text-black text-base font-OpenSansRegular">
                                                {"Aval Total"}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        <div className="w-12 h-12 bg-mainpink rounded-xl flex items-center flex-shrink-0">
                                        ...
                                        <div className="pl-4">
                                            ...
                                            {paymenttype === 2 &&
                                                <>
                                                    ...
                                                    <p className="text-black text-base font-OpenSansRegular">
                                                        {"Mastercard terminada en " + cardnumber.slice(-4)}
                                                    </p>
                                                </>
                                            }
                                        </div>
                    ...
                    <div className="w-full px-4 sm:px-12 xl:px-24 1xl:px-32 pt-10 block lg:flex justify-between mb-12">
                        <div>
                        ...
                        <div className="block md:flex items-center">
                            <div className="px-4 sm:pl-10 sm:pr-16 py-8 sm:py-10 rounded-xl shadow-xl mx-auto sm:w-327px bg-card mt-5">
                                ...
                                <p className="pt-4 pb-2 text-black text-xl font-SpartanBold ">Asesorate sobre tu garantía </p>
                                <p className="text-gray5 font-RobotoRegular text-sm">Comunicate 
                                    <span className="font-RobotoBold text-green4 px-1">
                                        {/* {sinisterphone} */}
                                        0800-222-444
                                    </span> 
                                     para poder ayudarte.
                            ...
                            <div className="pl-0 md:pl-4">
                                <div className="px-4 sm:pl-10 sm:pr-16 py-8 sm:py-10 rounded-xl shadow-xl mx-auto sm:w-327px bg-card mt-5">
                                    ...
                                    <p className="text-gray5 font-RobotoRegular text-sm">Llamanos al 
                                        <span className="font-RobotoBold text-green4 px-1">
                                            {/* {generalphone} */}
                                            0800-222-444
                                        </span> 
                                        para solucionar tus consultas.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* {!!appstoreUrl && !!googleplayUrl && */}
                        <div className="w-full px-4 sm:px-12 xl:px-24 1xl:px-32">
                            <div className="w-full bg-mainpink rounded-xl border border-purple4 flex pt-8 md:pt-12 pb-8 md:pb-0 pl-4 sm:pl-8 md:pl-0 pr-4 sm:pr-8 md:pr-4">
                                ...
                                <div className="pt-2 sm:pt-6">
                                    <p className="text-black text-xl sm:text-2xl font-SpartanBold">
                                        {!!quote.insurerObj ? quote.insurerObj.name : ""} Aval total App
                                    </p>
