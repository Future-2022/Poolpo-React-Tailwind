...
const HouseHiringPayment = (props) => {
                ...
                <div className="w-full max-w-1296 mx-auto relative bg-pink8 pb-12" style={{ minHeight: "100vh" }}>
                    <HeaderHiring quotationitem={false} logoID={(quote !== {} && !!quote.insurerObj) ? quote.insurerObj.id : false}>
                        {/* <div className="flex items-center pb-6">
                            ...
                            <span className="text-lg text-purple font-OpenSansRegular">Garantía de alquiler</span>
                            <img src={vector} alt="" className="mx-3" />
                    ...
                    <div className="w-full flex flex-row-reverse px-4 sm:px-12 xl:px-24 1xl:px-32">
                        ...
                        <>
                            <form className="w-full mr-0 md:mr-8" onSubmit={goHiringVehicle}>
                                ...
                                {selected === "first" && (
                                    <div className="w-full sm:pl-10 sm:pr-15 sm:pt-6 pb-8 border-b sm:border border-purple3 sm:rounded-xl mt-5">
                                        ...
                                        <div className="">
                                            <div className="w-full block lg:flex">
                                                <div className="w-full lg:w-1/2 xl:w-3/5 mb-4 sm:mb-0">
                                                    <CustomInput type="number" name="Número de CBU" content={CBUNumber} onChange={e => setCBUNumber(e.target.value)} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="">
                                            <div className="w-full block lg:flex">
                                                <div className="w-full lg:w-1/2 xl:w-3/5 mb-4 sm:mb-0">
                                                    ...
                                                    <div className="mt-8">
                                                        <InputDropdown list={rentalDurationList} type="text" name="Email" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                    </div>
                                                    <div className="mt-8 relative z-20">
                                                        <CustomInput type="number" name="Piso" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="w-full lg:w-1/2 xl:w-2/5 pt-8 lg:pt-0 pl-0 lg:pl-8 mb-4 sm:mb-0">
                                                    ...
                                                    <div className="w-full relative mt-8 z-10">
                                                        <InputDropdown list={rentalDurationList} type="text" name="Número" error={validError.email.error} errorMsg={validError.email.msg} content={email} onChange={e => setEmail(e.target.value)} />
                                                    </div>
                                                    <div className="w-full relative mt-8 z-10">
                                    ...
                                    <div className="w-full sm:pl-10 sm:pr-15 sm:pt-6 pb-8 border-b sm:border border-purple3 sm:rounded-xl mt-5">
                                        ...
                                        <div className="">
                                            <div className="w-full block">
                                                <div className="w-full lg:w-1/1 mb-4 sm:mb-0">
                                                    <CustomInput type="number" name="Número de CBU" content={CBUNumber} onChange={e => setCBUNumber(e.target.value)} />
                                                </div>
                                                <div className="w-full sm:mb-0 pt-8 lg:flex">
                                                    <InputDropdown list={rentalDurationList} type="text" name="Banco" content={bank} onChange={e => setBank(e.target.value)} />
                                                    <div style={{width:20}}></div>
                                                    <InputDropdown list={rentalDurationList} type="text" name="Tipo de cuenta" content={bank} onChange={e => setBank(e.target.value)} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default HouseHiringPayment;
