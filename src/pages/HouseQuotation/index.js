...
import HouseQuotationVerticalSelect from '../../components/HouseQuotationVerticalSelect'

const HouseQuotation = (props) => {
  ...
  useEffect(() => {
    ...
    apiGetQuotationData(props.match.params.quoteID, props.match.params.leadID)
      .then((res) => {
        console.log("res------", res)
        setLoading2(false);
  ...
  const goHiringPage = (id) => {
    let url = "/house/hiring/data/" + props.match.params.leadID + "/" + props.match.params.quoteID + "/" + id;
    history.push(url)
  }
