...
const MotoSteps = (props) => {
    ...
    useEffect(() => {
        ...
        if (data.state && data.state.brand) {
            ...
            console.log("data.state.version-----", data.state.version)
                    ...
                    <div className="w-full max-w-778 mr-auto">
                        <div className="w-full pl-4 sm:pl-8 pt-15">
                            ...
                            <div id="modal-wrapper" className="pt-10 pl-0 sm:pl-8 md:pl-0 lg:pl-16 pb-8 sm:pb-40">
                                {step === 1 &&
                                    <>
                                        <p className="text-black font-SpartanBold text-xl md:text-2xl pb-2 sm:pb-8 pr-4">Seleccioná la marca de tu moto</p>
